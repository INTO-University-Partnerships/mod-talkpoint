...
$string['viewyourtalkpoint'] = 'View your Talkpoint';
...
$string['viewcurrentfile'] = 'View current uploaded file';
...
$string['jsonapi:talkpointasguestdenied'] = 'You cannot comment on a talkpoint as the guest user';
